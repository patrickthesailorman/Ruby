...
=begin As we have seen in the previous lessons, we can loop over arrays and hashes using for loops. 
...
=begin In the example above, key and value are variables that get assigned to the corresponding values of the hash elements at each iteration. You can use any name for your variables.

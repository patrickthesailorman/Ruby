...
=begin The for loop is a useful statement when you need to loop over a specific set of values, for example, a range.
...
=begin This will output the numbers 1 to 10. 
...
=begin This will output only the odd numbers from 0 to 10 because the even numbers will skip the loop iteration.
...
=begin Another looping statement in Ruby is the loop do statement.
